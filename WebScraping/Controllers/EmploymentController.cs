    ...
    public class EmploymentController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            for (int i = 1; i < 4; i++)
            {
                ...
                {
                    string title = item.ChildNodes[2].ChildNodes[2].ChildNodes[0].ChildNodes[0].InnerText.Trim();
                    ...
                    string room = item.ChildNodes[2].ChildNodes[4].ChildNodes[0].ChildNodes[0].ChildNodes[0].ChildNodes[2].ChildNodes[0].ChildNodes[0].InnerText.Trim();
                    string link = "https://www.hepsiemlak.com" + item.ChildNodes[2].ChildNodes[0].ChildNodes[0].GetAttributeValue("href", "").Trim();
                    string img = item.ChildNodes[0].ChildNodes[2].ChildNodes[2].GetAttributeValue("src", "").Trim();
                    homes.Add(new Home()
                    {
                        title = title,
                        city = city,
